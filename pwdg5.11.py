...
class PwdgApp:
    ...
    def open_settings(self):
        ...
        y = self.master.winfo_rooty() + (self.master.winfo_height() // 2) - 100
        ...
        def copy_wallet(event=None):
            ...
            self.master.clipboard_append(WALLET_ADDRESS)
    ...
    def setup_ui(self):
        ...
        self.special_entry = ttk.Entry(entry_frame, width=20)
    ...
    def generate_password(self):
        ...
        # Увеличение шрифта, если длина пароля ровно 8
        if len(pwd_str) == 8:
            self.password_label.config(font=("Consolas", 14, "bold"))
        else:
            self.password_label.config(font=("Consolas", 10, "bold"))
